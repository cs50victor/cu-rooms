...
export default function Primitives() {
  ...
  return (
    <MarketingContainer title="Primitives" headerBorder footer>
      <main tw="min-h-[38rem]">
        <section tw="max-w-screen-lg mx-auto px-10 text-center mt-10">
          <h1 className="hero-headline" tw="md:(text-6xl)">
            Primitives
          </h1>
          <Container>
            <Dropdown
...
const exampleData = [
  ...
  [
    ...
    tw`from-amber-300 to-amber-500`,
  ],
  [
    "Switch (Toggle)",
    "https://headlessui.dev/react/switch",
    tw`from-green-400 to-blue-500`,
  ],
  [
    "Disclosure",
    "https://headlessui.dev/react/disclosure",
    tw`from-indigo-500 to-purple-600`,
  ],
  [
    "Dialog (Modal)",
    "https://headlessui.dev/react/dialog",
    tw`from-blue-400 to-indigo-500`,
  ],
  ["Popover", "https://headlessui.dev/react/popover", tw`from-amber-400 to-pink-600`],
  [
    "Radio Group",
    "https://headlessui.dev/react/radio-group",
    tw`from-blue-400 to-blue-500`,
  ],
  ["Transition", "https://headlessui.dev/react/transition", tw`from-pink-500 to-red-500`],
  ["Tabs", "https://headlessui.dev/react/tabs", tw`from-blue-400 to-blue-600`],
]
function Example({ className, children, index }) {
  ...
  return (
    <div css={[tw`space-y-4`, gradientStyles]}>
      ...
      <a href={demoUrl} target="_blank" rel="noopener noreferrer" tw="inline-block">
        Docs
